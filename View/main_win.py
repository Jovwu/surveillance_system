...
class MyMainForm(QMainWindow, Ui_main_win):
    def __init__(self, labelDict,CHANNEL_DICT,ChannelRefreshThreadDict,parent=None):
        ...
        # 表格
        # 设置行列
        self.P_data_table.setColumnCount(8)  # 设置列数
        self.P_data_table.setHorizontalHeaderLabels(['人员ID', '人员图像', '人员姓名', '人员类别', '宿舍', '班级', '修改', '删除'])
        # 表格控件字典
    ...
    def setD_tab_content(self):
        ...
        self.P_data_table.setRowCount(self.D_tab_curItemCount)  # 设置行数
        curRow = 0
